...
public class PostServiceTest {
    ...
    @BeforeEach
    public void setUp() {
        postDatabase = mock(PostDatabase.class);
        userDatabase = mock(UserDatabase.class);
        authDatabase = mock(AuthDatabase.class);
        errorLogger = mock(ErrorLogger.class);

        postService = new PostService(postDatabase, userDatabase, authDatabase, errorLogger);
    }
